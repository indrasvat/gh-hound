...
var footerByScreen = map[Screen][]Binding{
	ScreenWelcome: {
		{Key: "⏎", Action: "continue", Help: "continue", ShowInFooter: true},
	...
	ScreenRunsList: {
		...
		{Key: "↻", Action: "rerun", Help: "rerun", ShowInFooter: true},
		{Key: "✗", Action: "cancel", Help: "cancel", ShowInFooter: true},
	...
	ScreenDetail: {
		{Key: "⏎", Action: "expand", Help: "expand", ShowInFooter: true},
		{Key: "↻", Action: "rerun_job", Help: "rerun job", ShowInFooter: true},
		{Key: "R", Action: "rerun_failed", Help: "rerun failed", ShowInFooter: true},
		{Key: "✗", Action: "cancel", Help: "cancel", ShowInFooter: true},
		{Key: "⎋", Action: "back", Help: "back", ShowInFooter: true},
		{Key: "?", Action: "help", Help: "", ShowInFooter: true},
	},
	ScreenFailure: {
		{Key: "↻", Action: "rerun_failed", Help: "rerun failed", ShowInFooter: true},
	...
	ScreenWatch: {
		...
		{Key: "⎋", Action: "detach", Help: "detach", ShowInFooter: true},
	},
	ScreenLog: {
		{Key: "j/k", Action: "scroll", Help: "scroll", ShowInFooter: true},
		{Key: "g/G", Action: "top_bottom", Help: "top/bottom", ShowInFooter: true},
	...
	ScreenDispatch: {
		{Key: "⏎", Action: "run", Help: "run", ShowInFooter: true},
		{Key: "⇥", Action: "next", Help: "next", ShowInFooter: true},
		{Key: "⎋", Action: "cancel", Help: "cancel", ShowInFooter: true},
	},
	ScreenPalette: {
	...
	ScreenToasts: {
		{Key: "⎋", Action: "dismiss", Help: "dismiss", ShowInFooter: true},
