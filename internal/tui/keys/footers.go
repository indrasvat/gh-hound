...
var footerByScreen = map[Screen][]Binding{
	...
	ScreenLog: {
		...
		{Key: "t", Action: "time_jump", Help: "time", ShowInFooter: true},
	...
	ScreenPalette: {
		...
		{Key: "diff", Action: "diff", Help: "", ShowInFooter: true},
